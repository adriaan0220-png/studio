    ...
    <div className="p-8 flex-1 bg-indigo-50">
      ...
      <div className="relative h-[500px] w-full overflow-hidden rounded-lg shadow-lg">
        <Image
          ...
          alt="Equipo de Ttiko trans trabajando en la oficina"
          fill
