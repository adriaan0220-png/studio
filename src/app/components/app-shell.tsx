...
export function AppShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex min-h-screen w-full flex-col">
      <header className="sticky top-0 z-40 flex h-48 items-center gap-4 border-b bg-card px-4 md:px-6 print:hidden">
        <Logo />
        ...
        <Sheet open={isSheetOpen} onOpenChange={setIsSheetOpen}>
          ...
          <SheetContent side="left" className="flex flex-col p-0 w-[280px] bg-card">
            <div className="flex h-48 items-center border-b px-6">
              <Logo />
            </div>
