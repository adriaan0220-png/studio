  ...
  return (
    <footer className="bg-muted text-card-foreground border-t">
      <div className="container mx-auto py-8 px-4 md:px-6 text-center">
        <p className="font-semibold text-lg">Ttiko trans, S.L.</p>
        ...
        <div className="text-sm text-muted-foreground mb-4">
            ...
            <a href="mailto:info@ttikotrans.com" className="hover:text-primary transition-colors">info@ttikotrans.com</a>
        </div>
        
        <p className="text-xs text-muted-foreground">&copy; {new Date().getFullYear()} Ttiko trans, S.L.</p>
        {currentDate && (
