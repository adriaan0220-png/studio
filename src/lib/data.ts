...
export const products = [
  ...
  },
  {
    ...
    type: 'Internacional',
    origin: 'Tetiko Trans',
    specs: 'Gestión completa de transporte en la UE combinando carretera, ferrocarril y marítimo. Modalidades: Road Tanker | Isotank | Flexitank. Tiempo medio tránsito UE: ES → FR: 24–36 h, ES → DE / BE / NL: 48–72 h. Rutas frecuentes: Lyon, Marsella, Burdeos, Rotterdam, Amberes, Frankfurt. Documentación: DUA | EUR.1 | T1 | Packing list. Incoterms: DAP, CPT, FCA, DDP. Sistemas digitales: POD electrónico | Tracking API | Telemática 3.0.',
